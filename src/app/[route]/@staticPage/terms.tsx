          ...
          <div className="px-5 max-w-3xl mx-auto">
            ...
            <div className="text-base prose">
              <p>
                ...
                (“Streetlives”) <a href="/privacy-policy">Privacy Policy</a>,
                set forth the terms and conditions (“Terms”) that apply to your
                access and use of the Streetlives website, located at{" "}
                <a href="https://yourpeer.nyc">https://yourpeer.nyc</a>{" "}
                (together, the “Site”). “Streetlives” includes Streetlives and
              ...
              <p>
                ...
                <strong>
                  These Terms state that any disputes between you and
                  Streetlives must be resolved in arbitration or small claims
                  court.
                </strong>
              </p>
              ...
              <ol>
                <li>
                  <p>
                    ...
                    (i) be at least eighteen (18) years of age; and (ii) have
                    not previously been suspended or removed from the Services.
                  </p>
                </li>
                <li>
                  <p>
                ...
                <li>
                  ...
                  <ol type="A">
                    ...
                    <li>
                      <p>
                        Violate or encourage others to violate the rights of
                    ...
                    <li>
                      <p>
                        ...
                        unlawful, defamatory, libelous, inaccurate, or that a
                    ...
                    <li>
                      <p>
                        Interfere in any way with security-related features of
                        the Site;
                      </p>
                    </li>
                    <li>
                      <p>
                        ...
                        personal information about users or third parties
                        without their consent;
                      </p>
                    </li>
                    <li>
                      <p>
                        Access, monitor or copy any content or information of
                        the Site using any robot, spider, scraper, or other
                        automated means or any manual process for any purpose
                        without Streetlives’ express written permission;
                      </p>
                    </li>
                    <li>
                      <p>
                        ...
                        accessing the accounts of other users without
                        permission, or falsifying your identity or any
                        information about you, including age or date of birth;
                        or
                      </p>
                    </li>
                    <li>
                ...
                <li>
                  <p>
                    ...
                    endorse these websites and services. You acknowledge and
                    agree that Streetlives has not reviewed the content,
                    advertising, products, services, or other materials that
                ...
                <li>
                  <p>
                    ...
                    agree that you relinquish all ownership rights in any ideas
                    or suggestions that you submit to Streetlives through this
                    Site. This Site is protected by applicable copyright and
                    other intellectual property laws, and no materials from the
                    Site may be copied, reproduced, republished, uploaded,
                    posted, transmitted, or distributed in any way without our
                    express permission. All trademarks and service marks on the
                    Site belong to Streetlives except third-party trademarks or
                    service marks, which are the property of their respective
                    owners.
                  </p>
                </li>
                <li>
                  <p>
                    ...
                    personally responsible for your use of the Site, and you
                    agree to defend, indemnify, and hold harmless Streetlives
                    from and against any and all claims, liabilities, damages,
                    losses, and expenses (including attorneys’ and accounting
                    fees and costs), arising out of or in any way connected with
                    (i) your access to, use of, or alleged use of the Site; (ii)
                    your violation of the Terms or any applicable law or
                    regulation; (iii) your violation of any third party right,
                    including without limitation any intellectual property
                    right, publicity, confidentiality, property, or privacy
                    right; or (iv) any disputes or issues between you and any
                    third party. Streetlives reserves the right, at our own
                    expense, to assume the exclusive defense and control of any
                    matter otherwise subject to indemnification by you, and in
                    such case, you agree to cooperate with our defense of such
                    claim.
                  </p>
                </li>
                <li>
                  <p>
                    ...
                    incorporated into these Terms. We will make reasonable
                    efforts to notify you of any material changes to the Terms,
                    including, but not limited to, by posting a notice to our
                    website or by sending an email to any address you may have
                    provided to us. Your continued use of the Services following
                    notice will be deemed acceptance of any modifications to the
                    Terms.
                  </p>
                </li>
                <li>
                  <p>
                    <strong>Disclaimers of Warranties. </strong> The Site
                    provided “as is” and on an “as available” basis, without
                    warranty or condition of any kind, either express or
                    implied. Although Streetlives seeks to maintain safe,
                    secure, accurate, and well-functioning services, we cannot
                    guarantee the continuous operation of or access to our Site,
                    and there may at times be inadvertent technical or factual
                    errors or inaccuracies. Streetlives specifically (but
                    without limitation) disclaims (i) any implied warranties of
                ...
                <li>
                  <p>
                    ...
                    consequential, direct, indirect, or punitive damages,
                    whether based on warranty, contract, tort (including
                    negligence), statute, or any other legal theory, whether or
                    not Streetlives has been informed of the possibility of such
                    damage. Some jurisdictions do not allow the disclaimer of
                    warranties or limitation of liability in certain
                    circumstances. Accordingly, some of the above limitations
                ...
                <li>
                  <p>
                    ...
                    conflict of law principles. Subject to Section 11, which
                    provides that disputes are to be resolved through binding
                    arbitration or small claims court, to the extent that any
                    lawsuit or court proceeding is permitted hereunder, you and
                    Streetlives agree to submit to the exclusive personal
                    jurisdiction of the state courts and federal courts located
                    within New York County, NY for the purpose of litigating all
                    such disputes.
                  </p>
                </li>
                <li>
                ...
                <li>
                  <p>
                    ...
                    for any modification, suspension, or discontinuance of any
                    of the Site. <br />
                  </p>
                </li>
                <li>
                  ...
                  <ol type="A">
                    ...
                    <li>
                      <p>
                        <span className="underline">No Waiver. </span> The
                        failure to require performance of any provision shall
                        not affect our right to require performance at any time
                        thereafter, nor shall a waiver of any breach or default
                        of the Terms constitute a waiver of any subsequent
                    ...
                    <li>
                      <p>
                        ...
                        only and shall not have any impact on the interpretation
                    ...
                    <li>
                      <p>
                        ...
                        event that any part of the Terms is held to be invalid
                        or unenforceable, the unenforceable part shall be given
                ...
                <li>
                  <p>
                    ...
                    California 95834, or by telephone at (800) 952-5210 in order
