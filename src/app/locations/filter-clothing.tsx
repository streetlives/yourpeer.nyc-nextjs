...
import { CLOTHING_PARAM_CASUAL_VALUE, CLOTHING_PARAM, CLOTHING_PARAM_PROFESSIONAL_VALUE } from "../common";
      ...
      <div className="mt-2 flex w-full">
        ...
        >
          <input
            ...
            value={
              clothingParam == CLOTHING_PARAM_CASUAL_VALUE ? "true" : undefined
            }
            className="sr-only"
        ...
        >
          <input
            ...
            value={
              clothingParam == CLOTHING_PARAM_PROFESSIONAL_VALUE ? "true" : undefined
            }
            className="sr-only"
